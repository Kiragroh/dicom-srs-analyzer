...
| `supplementary_all_metrics_subplots.png` | **Supplementary:** 3×3 subplot grid with 9 metrics (CI, GI, D98%, V100%, D50%, D2%, Dmax%, HI, RTOG_CI) |
| `supplementary_all_metrics.pdf` | **Supplementary:** Multi-page PDF (4 pages): Figure + 2 Tables + Legend |
| `supplementary_with_readme.pdf` | **Combined:** Supplementary + appended README documentation |
| `supplementary_all_metrics.xlsx` | **Supplementary:** Comprehensive metrics table (Mean/Std/Median/Min/Max per setup) |
| `supplementary_statistics.xlsx` | **Supplementary:** Statistics (Mean/Std/Median) for all 9 metrics |
